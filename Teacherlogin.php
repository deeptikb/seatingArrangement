...
<tr> 
	  ...
	  <tr>
      <td class="noborder" style="color:white;">EMAIL ADDRESS</td>
...
<tr>  
      <td class="noborder" style="color:white;">PASSWORD</td>
	  <td class="noborder"><input type="password" name="password" style="border:0;border-radius:10px;height:30px;" placeholder="password" required></td>
</tr>
<tr>  <td class="noborder" colspan='5' align="center"><input type="submit" value="signup" name="signup"></td></tr>
</table>
<?php
if(isset($_GET['error'])==true){
	echo '<font color=red><p align="center">W</p></font>';
}
?>
</form>
</div>
...
if(isset($_POST['signup']))
 {
	 $pass=$_POST['password'];
	 $email=$_POST['emailid'];
	 $query=mysqli_query($conn,"select * from invigilator where idno='$pass' && email_id='$email'");
